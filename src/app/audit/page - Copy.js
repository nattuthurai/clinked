          ...
          <div className="bg-white p-6 rounded-md shadow-md space-y-4">
            ...
            <div>
              ...
              <div className="flex items-center space-x-4 mt-2">
                 <div className="flex items-center space-x-2"> 
                  ...
                  <div className="w-25 border px-3 py-1 mt-2 rounded-md focus:outline-none focus:ring focus:ring-blue-300">
                    <ReactDatePicker
            ...
            <div className="flex items-center space-x-4 mt-2">
              ...
              <select
                ...
                className="w-96 border px-3 py-1 mt-2 rounded-md focus:outline-none focus:ring focus:ring-blue-300"
              >
            ...
            <div className="flex items-center space-x-4 mt-2">
              <label className="block text-bg font-bold pr-2">Users:</label>
              <select
                id="dropdown"
