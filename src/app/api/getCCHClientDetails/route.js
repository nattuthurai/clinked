...
const listId = process.env.CCH_CLIENTS_ID;
...
export async function GET(req) {
    try {
      ...
      const graphEndpoint = `https://graph.microsoft.com/v1.0/sites/root/lists/${listId}/items?$expand=fields($select=ClientName,ClientID,ClientType,Year)`;
